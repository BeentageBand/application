...
FSM_STATE_DEF(cb, APP_NOT_RUNNING_STID, \
    FSM_TRANSITION_DEF(cb, APP_INT_THREAD_INIT_MID,       APP_IDLE_STID,   App_FSM_Start_Thread) \
) \
FSM_STATE_DEF(cb, APP_IDLE_STID, \
    FSM_TRANSITION_DEF(cb, APP_INT_THREAD_ACTIVE_REQ_MID, APP_ACTIVE_STID, App_FSM_Activate_Thread) \
    FSM_TRANSITION_DEF(cb, APP_INT_THREAD_TERM_MID,       APP_TERM_STID,   App_FSM_Term_Thread) \
) \
FSM_STATE_DEF(cb, APP_ACTIVE_STID, \
    FSM_TRANSITION_DEF(cb, APP_INT_THREAD_IDLE_REQ_MID,   APP_IDLE_STID,   App_FSM_Idle_Thread) \
    FSM_TRANSITION_DEF(cb, APP_INT_THREAD_TERM_MID,       APP_TERM_STID,   App_FSM_Term_Thread) \
) \
FSM_STATE_DEF(cb, APP_TERM_STID, \
    FSM_TRANSITION_DEF(cb, APP_INT_THREAD_TERM_MID,       APP_TERM_STID,   App_FSM_Do_Nothing) \
)
